  ...
  <table className="min-w-full bg-white">
    ...
    <tbody className="whitespace-nowrap">
      <tr className="hover:bg-gray-50">
        <td className="p-4 text-[15px] text-gray-800">John Doe</td>
        <td className="p-4 text-[15px] text-gray-800">john@example.com</td>
        <td className="p-4 text-[15px] text-gray-800">Admin</td>
        <td className="p-4 text-[15px] text-gray-800">2022-05-15</td>
        <td className="p-4">
      ...
      <tr className="hover:bg-gray-50">
        ...
        <td className="p-4 text-[15px] text-gray-800">2022-07-20</td>
        <td className="p-4">
          <button className="mr-4" title="Edit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <tr className="hover:bg-gray-50">
        ...
        <td className="p-4 text-[15px] text-gray-800">User</td>
        <td className="p-4 text-[15px] text-gray-800">2022-07-21</td>
        <td className="p-4">
          <button className="mr-4" title="Edit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <tr className="hover:bg-gray-50">
        ...
        <td className="p-4 text-[15px] text-gray-800">User</td>
        <td className="p-4 text-[15px] text-gray-800">2020-07-06</td>
        <td className="p-4">
          <button className="mr-4" title="Edit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
      ...
      <tr className="hover:bg-gray-50">
        ...
        <td className="p-4 text-[15px] text-gray-800">User</td>
        <td className="p-4 text-[15px] text-gray-800">2021-07-06</td>
        <td className="p-4">
          <button className="mr-4" title="Edit">
            <svg
              xmlns="http://www.w3.org/2000/svg"
